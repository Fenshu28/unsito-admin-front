      ...
      <div className="max-w-full overflow-x-auto">
        <table className="w-full">
          <thead className="border-gray-100 dark:border-gray-800 border-y">
            <tr>
              <th className="py-3 px-2 font-medium text-gray-500 text-left text-xs dark:text-gray-400">
                #
              </th>
              <th className="py-3 px-2 font-medium text-gray-500 text-left text-xs dark:text-gray-400">
                Título
              ...
              <th className="py-3 px-2 font-medium text-gray-500 text-center text-xs dark:text-gray-400">
                Vistas
              </th>
              <th className="py-3 px-2 font-medium text-gray-500 text-center text-xs dark:text-gray-400">
                Descargas
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            {publications.map((item, index) => (
              <tr key={item.publicacion._id} className="hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                <td className="py-3 px-2 text-gray-500 text-sm dark:text-gray-400">
                  {index + 1}
                </td>
                ...
                <td className="py-3 px-2 text-center text-gray-800 text-sm font-medium dark:text-white/90">
